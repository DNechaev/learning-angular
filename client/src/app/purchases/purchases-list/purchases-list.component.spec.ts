...
describe('PurchasesListComponent', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(purchasesService, 'getPurchases')
      .withArgs(
  ...
  it('load purchase page 1', () => {
    component.loadData(1);
    expect(component.purchases).toEqual(expectPage1.rows);
  });

  it('load purchase page 2', () => {
    component.loadData(2);
    expect(component.purchases).toEqual(expectPage2.rows);
  });
  ...
  it('get purchases by searchService subscription', () => {
    searchService.set('test');
    expect(component.purchases).toEqual(expectPage3.rows);
  });
